...
constructor(){
  ...
  async modificar (id,data) {return await modeloHabitacion.findByIdAndUpdate(id, data);}



  async buscar() {    let buscarHabitaciones = await modeloHabitacion.find();
...
async registrar(data) {
 ...
 async eliminar(id) {let eliminarHabitacion = await modeloHabitacion.findByIdAndDelete(id);
